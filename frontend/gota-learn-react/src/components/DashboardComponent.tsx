  ...
  return (
    <>
      ...
      <header className="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a className="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Gota Learn</a>
            ...
            <div className="offcanvas-md offcanvas-end bg-body-tertiary" id="sidebarMenu"
              ...
              <div className="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                <ul className="nav flex-column">
                  ...
                  <li className="nav-item">
                    <Link to="/dashboard/create-course" className="nav-link d-flex align-items-center gap-2">
                      <svg className="bi">
                  ...
                  <li className="nav-item">
                    <Link to="/dashboard/create-lessons" className="nav-link d-flex align-items-center gap-2">
                      <svg className="bi">
                  ...
                  <li className="nav-item">
                    <Link to="/dashboard/course-management" className="nav-link d-flex align-items-center gap-2">
                      <svg className="bi">
